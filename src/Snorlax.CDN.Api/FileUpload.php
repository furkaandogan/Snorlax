...
function upload(){
    global $host;
    global $appId;;
    $filePath="files/".$appId."/".$_POST["Content"]."/".$_POST["FileType"];
    ...
    foreach ($_FILES["image"]["error"] as $key => $error) {
        if ($error == UPLOAD_ERR_OK) {
            ...
            if ($result)
            {
		        ...
		        $file["orginal_Link"]=$host."/GetFile.php?FilePath=".$filePath."/$name"."&w=0&h=0";
		        $file["100x100_Link"]=$host."/GetFile.php?FilePath=".$filePath."/$name"."&w=100&h=100";
